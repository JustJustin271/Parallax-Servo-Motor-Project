...
const int clockSpeed = 45;     
const int countSpeed = 130; 
...
unsigned long totalRun = 40000; //Total time the motor will be on if the button is pressed 
unsigned long accTime = 3000;  //Time for acceleration (Milliseconds)
unsigned long decTime = 5000;  //Time for deceleration
